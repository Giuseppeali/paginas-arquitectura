        ...
        <footer id="contact" className="bg-[#0a0a0a] pt-32 pb-12 border-t border-white/10 mt-20">
            <div className="max-w-7xl mx-auto px-6 md:px-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-24">
                    ...
                    <div>
                        <h4 className="text-xs tracking-[0.2em] uppercase text-gray-500 mb-6">{t.contact.offices}</h4>
                    ...
                    <div>
                        <h4 className="text-xs tracking-[0.2em] uppercase text-gray-500 mb-6">{t.footer.social}</h4>
